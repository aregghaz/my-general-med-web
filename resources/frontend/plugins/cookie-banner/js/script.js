                ...
                function r(n) {
                    ...
                    (r.style.display = 'none'),
                        ...
                        (this.onButtonEnter = function (t) {
                            13 === t.keyCode &&
                                (t.preventDefault(), this.setStatus('dismiss'), this.close());
                        }.bind(this));
                ...
                return (
                    ...
                    (i.prototype.open = function (e) {
                        if (this.element)
                            return (
                                this.isOpen() ||
                                    (t.fading ? this.fadeIn() : (this.element.style.display = '')),
                                this
                            );
                    }),
                    ...
                    (i.prototype.fadeIn = function () {
                        ...
                        if (
                            t.fading &&
                            n &&
                            (this.afterFading && o.call(this, n), e.hasClass(n, 'wpcc-invisible'))
                        ) {
...
window.addEventListener('load', function () {
    window.wpcc.init({
        ...
        content: {
            message:
                'Этот веб-сайт использует куки-файлы, чтобы обеспечить вам максимальную отдачу от нашего веб-сайта.',
            link: 'Подробнее',
            button: 'Понятно',
        },
    });
