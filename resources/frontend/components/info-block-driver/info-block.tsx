                    ...
                    <>
                        ...
                        <div className={cls.documents}>
                            ...
                            <div className={cls.itemBorder}>
                                ...
                                <br />
                                <span>Expiration : {newData.company_training_exp}</span>
                            </div>
                            <div className={cls.itemBorder}>
                                <span className={cls.b_text}>{t("drug_test")} : </span>
                                <a href={newData.drug_test} target="_blank">Download</a>
                                <br />
                                <span>Expiration : {newData.drug_test_exp}</span>
                            </div>
                        </div>
                    </>
                }
