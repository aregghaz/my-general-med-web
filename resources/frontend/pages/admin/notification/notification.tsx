    ...
    return data && (
        ...
        <>
            ...
            {model && <div className={s.infoSection}>
               <div style={{display:"flex", flexDirection:"row", alignContent:"end", justifyContent:'end', padding: "10px 10px 0 0 "}}> <CloseSvg style={{cursor: "pointer"}} onClick={handlerClose}/></div>
